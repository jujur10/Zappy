...
namespace atomic_queue {
constexpr int CACHE_LINE_SIZE = 128; // : Review that this is the correct value.
static inline void spin_loop_pause() noexcept {
    asm volatile("or 31,31,31 # very low priority"); // : Review and benchmark that this is the right instruction.
}
} // namespace atomic_queue
#elif defined(__s390x__)
namespace atomic_queue {
constexpr int CACHE_LINE_SIZE = 256; // : Review that this is the correct value.
static inline void spin_loop_pause() noexcept {} // : Find the right instruction to use here, if any.
} // namespace atomic_queue
...
#endif
namespace atomic_queue {
constexpr int CACHE_LINE_SIZE = 64; // : Review that this is the correct value.
static inline void spin_loop_pause() noexcept {}
} // namespace atomic_queue
#endif
